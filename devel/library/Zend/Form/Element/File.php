...
class Zend_Form_Element_File extends Zend_Form_Element_Xhtml {
	...
	public function loadDefaultDecorators() {
		...
		if (empty ( $decorators )) {
			$this->addDecorator ( 'File' )->addDecorator ( 'Errors' )->addDecorator ( 'HtmlTag', array ('tag' => 'dd' ) )->addDecorator ( 'Label', array ('tag' => 'dt' ) );
		}
	}
	...
	public function isValid($value, $context = null) {
		...
		if (! $this->isRequired ()) {
			...
			if ($this->autoInsertNotEmptyValidator () and ! $this->getValidator ( 'NotEmpty' )) {
