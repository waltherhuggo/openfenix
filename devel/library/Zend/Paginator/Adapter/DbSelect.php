...
class Zend_Paginator_Adapter_DbSelect implements Zend_Paginator_Adapter_Interface {
	...
	public function count() {
		if ($this->_rowCount === null) {
			...
			$rowCount->reset ( Zend_Db_Select::COLUMNS )->reset ( Zend_Db_Select::ORDER )->reset ( Zend_Db_Select::LIMIT_OFFSET )->reset ( Zend_Db_Select::GROUP )->reset ( Zend_Db_Select::DISTINCT )->columns ( $expression );
