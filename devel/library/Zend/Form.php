...
class Zend_Form implements Iterator, Countable, Zend_Validate_Interface {
	...
	public function setOptions(array $options) {
		...
		$forbidden = array ('Options', 'Config', 'PluginLoader', 'SubForms', 'View', 'Translator', 'Attrib', 'Default' );
	...
	public function getPluginLoader($type = null) {
		...
		if (! isset ( $this->_loaders [$type] )) {
			...
			$this->_loaders [$type] = new Zend_Loader_PluginLoader ( array ('Zend_' . $prefixSegment . '_' => 'Zend/' . $pathSegment . '/' ) );
		}
	...
	public function addElementPrefixPath($prefix, $path, $type = null) {
		$this->_elementPrefixPaths [] = array ('prefix' => $prefix, 'path' => $path, 'type' => $type );
	...
	public function addDisplayGroupPrefixPath($prefix, $path) {
		$this->_displayGroupPrefixPaths [] = array ('prefix' => $prefix, 'path' => $path );
