...
abstract class Zend_Server_Reflection_Function_Abstract {
	...
	protected function _reflect() {
		...
		if (count ( $paramTypesTmp ) != $paramCount) {
			throw new Zend_Server_Reflection_Exception ( 'Variable number of arguments is not supported for services (except optional parameters). ' . 'Number of function arguments must currespond to actual number of arguments described in a docblock.' );
		}
