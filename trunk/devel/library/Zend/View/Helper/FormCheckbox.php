...
class Zend_View_Helper_FormCheckbox extends Zend_View_Helper_FormElement {
	 ...
	 * @var array
	 */
	protected static $_defaultCheckedOptions = array ('checked' => '1', 'unChecked' => '0' );
	...
	public static function determineCheckboxInfo($value, $checked, array $checkedOptions = null) {
		...
		return array ('checked' => $checked, 'checkedString' => $checkedString, 'checkedValue' => $checkedValue, 'unCheckedValue' => $unCheckedValue );
	}
}
