...
class Zend_Validate_File_Crc32 extends Zend_Validate_File_Hash {
	 ...
	 */
	protected $_messageTemplates = array (self::DOES_NOT_MATCH => "The file '%value%' does not match the given crc32 hashes", self::NOT_DETECTED => "There was no crc32 hash detected for the given file", self::NOT_FOUND => "The file '%value%' could not be found" );
