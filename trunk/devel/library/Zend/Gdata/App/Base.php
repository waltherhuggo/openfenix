...
abstract class Zend_Gdata_App_Base {
	...
	protected function takeAttributeFromDOM($attribute) {
		...
		$this->_extensionAttributes [$arrayIndex] = array ('namespaceUri' => $attribute->namespaceURI, 'name' => $attribute->localName, 'value' => $attribute->nodeValue );
	}
	 ...
	 * @return void
	 */
	public function registerNamespace($prefix, $namespaceUri, $majorVersion = 1, $minorVersion = null) {
