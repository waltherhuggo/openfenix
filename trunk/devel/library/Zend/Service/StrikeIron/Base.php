...
class Zend_Service_StrikeIron_Base {
	...
	protected function _initSoapHeaders() {
		...
		if (! $foundLicenseInfo) {
			$this->_options ['headers'] [] = new SoapHeader ( 'http://ws.strikeiron.com', 'LicenseInfo', array ('RegisteredUser' => array ('UserID' => $this->_options ['username'], 'Password' => $this->_options ['password'] ) ) );
		}
	}
