...
class Zend_Service_Yahoo {
	...
	public function inlinkDataSearch($query, array $options = array()) {
		static $defaultOptions = array ('results' => '50', 'start' => 1 );
	...
	public function imageSearch($query, array $options = array()) {
		static $defaultOptions = array ('type' => 'all', 'results' => 10, 'start' => 1, 'format' => 'any', 'coloration' => 'any' );
	...
	public function localSearch($query, array $options = array()) {
		static $defaultOptions = array ('results' => 10, 'start' => 1, 'sort' => 'distance', 'radius' => 5 );
	...
	public function newsSearch($query, array $options = array()) {
		static $defaultOptions = array ('type' => 'all', 'start' => 1, 'sort' => 'rank' );
	...
	public function videoSearch($query, array $options = array()) {
		static $defaultOptions = array ('type' => 'all', 'results' => 10, 'start' => 1, 'format' => 'any' );
	...
	public function webSearch($query, array $options = array()) {
		static $defaultOptions = array ('type' => 'all', 'start' => 1, 'license' => 'any', 'results' => 10, 'format' => 'any' );
	...
	protected function _validateLocalSearch(array $options) {
		$validOptions = array ('appid', 'query', 'results', 'start', 'sort', 'radius', 'street', 'city', 'state', 'zip', 'location', 'latitude', 'longitude' );
	...
	protected function _validateWebSearch(array $options) {
		$validOptions = array ('appid', 'query', 'results', 'start', 'language', 'type', 'format', 'adult_ok', 'similar_ok', 'country', 'site', 'subscription', 'license' );
	...
	protected function _validateLanguage($lang) {
		$languages = array ('ar', 'bg', 'ca', 'szh', 'tzh', 'hr', 'cs', 'da', 'nl', 'en', 'et', 'fi', 'fr', 'de', 'el', 'he', 'hu', 'is', 'id', 'it', 'ja', 'ko', 'lv', 'lt', 'no', 'fa', 'pl', 'pt', 'ro', 'ru', 'sk', 'sr', 'sl', 'es', 'sv', 'th', 'tr' );
