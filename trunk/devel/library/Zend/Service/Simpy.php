...
class Zend_Service_Simpy {
	...
	public function renameTag($fromTag, $toTag) {
		$query = array ('fromTag' => $fromTag, 'toTag' => $toTag );
	...
	public function mergeTags($fromTag1, $fromTag2, $toTag) {
		$query = array ('fromTag1' => $fromTag1, 'fromTag2' => $fromTag2, 'toTag' => $toTag );
	...
	public function splitTag($tag, $toTag1, $toTag2) {
		$query = array ('tag' => $tag, 'toTag1' => $toTag1, 'toTag2' => $toTag2 );
	...
	public function saveLink($title, $href, $accessType, $tags = null, $urlNickname = null, $note = null) {
		...
		$query = array ('title' => $title, 'href' => $href, 'accessType' => $accessType, 'tags' => $tags, 'urlNickname' => $urlNickname, 'note' => $note );
	...
	public function getWatchlist($watchlistId) {
		$query = array ('watchlistId' => $watchlistId );
	...
	public function saveNote($title, $tags = null, $description = null, $noteId = null) {
		...
		$query = array ('title' => $title, 'tags' => $tags, 'description' => $description, 'noteId' => $noteId );
