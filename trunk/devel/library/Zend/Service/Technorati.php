...
class Zend_Service_Technorati {
	...
	public function cosmos($url, $options = null) {
		static $defaultOptions = array ('type' => 'link', 'start' => 1, 'limit' => 20, 'current' => 'yes', 'format' => 'xml', 'claim' => 0, 'highlight' => 1 );
	...
	public function search($query, $options = null) {
		static $defaultOptions = array ('start' => 1, 'limit' => 20, 'format' => 'xml', 'claim' => 0 );
	...
	public function tag($tag, $options = null) {
		static $defaultOptions = array ('start' => 1, 'limit' => 20, 'format' => 'xml', 'excerptsize' => 100, 'topexcerptsize' => 150 );
	...
	public function dailyCounts($query, $options = null) {
		static $defaultOptions = array ('days' => 180, 'format' => 'xml' );
	...
	public function topTags($options = null) {
		static $defaultOptions = array ('start' => 1, 'limit' => 20, 'format' => 'xml' );
	...
	protected function _validateCosmos(array $options) {
		static $validOptions = array ('key', 'url', 'type', 'limit', 'start', 'current', 'claim', 'highlight', 'format' );
	...
	protected function _validateSearch(array $options) {
		static $validOptions = array ('key', 'query', 'language', 'authority', 'limit', 'start', 'claim', 'format' );
	...
	protected function _validateTag(array $options) {
		static $validOptions = array ('key', 'tag', 'limit', 'start', 'excerptsize', 'topexcerptsize', 'format' );
	...
	protected function _validateDailyCounts(array $options) {
		static $validOptions = array ('key', 'q', 'days', 'format' );
	...
	protected function _validateGetInfo(array $options) {
		static $validOptions = array ('key', 'username', 'format' );
	...
	protected function _validateTopTags(array $options) {
		static $validOptions = array ('key', 'limit', 'start', 'format' );
	...
	protected function _validateBlogInfo(array $options) {
		static $validOptions = array ('key', 'url', 'format' );
	...
	protected function _validateBlogPostTags(array $options) {
		static $validOptions = array ('key', 'url', 'limit', 'start', 'format' );
