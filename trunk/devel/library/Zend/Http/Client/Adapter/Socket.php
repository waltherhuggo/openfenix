...
class Zend_Http_Client_Adapter_Socket implements Zend_Http_Client_Adapter_Interface {
	 ...
	 * @var array
	 */
	protected $config = array ('persistent' => false, 'ssltransport' => 'ssl', 'sslcert' => null, 'sslpassphrase' => null );
	...
	public function setConfig($config = array()) {
		if (! is_array ( $config )) {
			...
			throw new Zend_Http_Client_Adapter_Exception ( '$concig expects an array, ' . gettype ( $config ) . ' recieved.' );
		}
