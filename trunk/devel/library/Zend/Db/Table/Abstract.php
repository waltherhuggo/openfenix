...
abstract class Zend_Db_Table_Abstract {
	...
	public function info($key = null) {
		...
		$info = array (self::SCHEMA => $this->_schema, self::NAME => $this->_name, self::COLS => $this->_getCols (), self::PRIMARY => ( array ) $this->_primary, self::METADATA => $this->_metadata, self::ROW_CLASS => $this->_rowClass, self::ROWSET_CLASS => $this->_rowsetClass, self::REFERENCE_MAP => $this->_referenceMap, self::DEPENDENT_TABLES => $this->_dependentTables, self::SEQUENCE => $this->_sequence );
	...
	public function fetchAll($where = null, $order = null, $count = null, $offset = null) {
		...
		$data = array ('table' => $this, 'data' => $rows, 'readOnly' => $select->isReadOnly (), 'rowClass' => $this->_rowClass, 'stored' => true );
