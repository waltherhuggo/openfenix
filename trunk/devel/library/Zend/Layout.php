...
class Zend_Layout {
	...
	public function getInflector() {
		if (null === $this->_inflector) {
			...
			$inflector->setTargetReference ( $this->_inflectorTarget )->addRules ( array (':script' => array ('Word_CamelCaseToDash', 'StringToLower' ) ) )->setStaticRuleReference ( 'suffix', $this->_viewSuffix );
