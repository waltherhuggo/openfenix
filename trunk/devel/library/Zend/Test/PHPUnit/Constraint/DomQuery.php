...
class Zend_Test_PHPUnit_Constraint_DomQuery extends PHPUnit_Framework_Constraint {
	 ...
	 * @var array
	 */
	protected $_assertTypes = array (self::ASSERT_QUERY, self::ASSERT_CONTENT_CONTAINS, self::ASSERT_CONTENT_REGEX, self::ASSERT_CONTENT_COUNT, self::ASSERT_CONTENT_COUNT_MIN, self::ASSERT_CONTENT_COUNT_MAX );
